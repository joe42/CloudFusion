...
class DictXMLParser(object):
    ...
    def __populate_dict(self, dom_tree, dict_tree):
        ...
        :param dict_tree: A dictionary of keys/values matching the first XML subtree in *dom_tree*
        """
    ...
    def populate_dict_with_XML_leaf_textnodes(self, xml_data, dict_tree):
        ...
        :param dict_tree: A dictionary of keys/values matching the first XML subtree in *xml_tree*
        """
