...
def setUp():
    io_apis.append( GoogleDrive( get_gdrive_config() ) )
    io_apis.append( ChunkMultiprocessingCachingStore( ( GoogleDrive( get_gdrive_config() ) ) ) )
    io_apis.append( MetadataCachingStore( GoogleDrive( get_gdrive_config() ) ) )
    time.sleep(10)
